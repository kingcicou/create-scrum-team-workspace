...
#
# Usage (remote + 项目名):
#   $env:PROJECT_NAME="my-project"; irm https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.0.0-rc.2/create.ps1 | iex
#
# Usage (local clone):
...
$Ref  = if ($env:SCRUM_TEMPLATE_REF) { $env:SCRUM_TEMPLATE_REF } else { "v1.0.0-rc.2" }
