...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.1.0-rc.7/create.sh) my-project
```

可叠加任意 CLI 选项：

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.1.0-rc.7/create.sh) my-project --type=new --preset=tech
```
...
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.7 my-project

# 仅预览不写盘
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.7 my-project --dry-run

# 交互式
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.7 --interactive
```
