...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.1.0-rc.6/create.sh) my-project
```

可叠加任意 CLI 选项：

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.1.0-rc.6/create.sh) my-project --type=new --preset=tech
```

### 方式二：PowerShell 一键执行（Windows）

```powershell
irm https://raw.githubusercontent.com/kingcicou/create-scrum-team-workspace/v1.1.0-rc.6/create.ps1 | iex
```
...
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.6 my-project

# 仅预览不写盘
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.6 my-project --dry-run

# 交互式
npx -y github:kingcicou/create-scrum-team-workspace#v1.1.0-rc.6 --interactive
```
